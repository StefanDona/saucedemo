...
class ProductPage {
  ...
  async placeOrder() {
    ...
    await t.typeText(this.firstName, chance.first(), { replace: true });
    await t.typeText(this.lastName, chance.last(), { replace: true });
    await t.typeText(this.zipCode, chance.zip(), { replace: true });
